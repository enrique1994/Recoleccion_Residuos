 ...
 */
public class LoginActivity extends AppCompatActivity implements OnNavigationItemSelectedListener,LoaderCallbacks<Cursor>  {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            // Handle the camera action
            Intent i = new Intent(LoginActivity.this, RouteActivity.class);
            startActivity(i);
