...
public class EventActivity extends AppCompatActivity implements OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent i = new Intent(EventActivity.this, MainActivityUser.class);
            startActivity(i);
        }
        else if (id == R.id.nav_camera) {

            // Handle the camera action
            Intent i = new Intent(EventActivity.this, RouteActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_gallery) {
            Intent i = new Intent(EventActivity.this, InformationActivity.class);
            ...
            Intent i = new Intent(EventActivity.this, RecyclerActivity.class);
